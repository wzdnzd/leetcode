/*
 * @lc app=leetcode.cn id=2163 lang=golang
 *
 * [2163] 删除元素后和的最小差值
 *
 ...
 * 如果我们删除元素 nums[2] = 5 和 nums[3] = 8 ，剩下元素为 [7,9,1,3] 。和的差值为 (7+9) - (1+3) =
 * 12 。
...
func minimumDifference(nums []int) int64 {
	...
	for i := n; i < m-n; i++ {
		...
		result = min(result, preMin-sufMax[i+1])
	}
