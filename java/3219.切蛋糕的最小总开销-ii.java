/*
 * @lc app=leetcode.cn id=3219 lang=java
 *
 * [3219] 切蛋糕的最小总开销 II
 *
...
class Solution {
    public long minimumCost(int m, int n, int[] horizontalCut, int[] verticalCut) {
        ...
        long minCost = 0;
        int horizontalIndex = m - 2, verticalIndex = n - 2;
        ...
        while (horizontalIndex >= 0 && verticalIndex >= 0) {
            if (horizontalCut[horizontalIndex] >= verticalCut[verticalIndex]) {
                minCost += horizontalCut[horizontalIndex] * horizontalCount;
                horizontalIndex--;
                verticalCount++;
            } else {
                minCost += verticalCut[verticalIndex] * verticalCount;
                verticalIndex--;
                horizontalCount++;
            }
        }
